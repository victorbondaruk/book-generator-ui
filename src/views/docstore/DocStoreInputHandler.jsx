...
const DocStoreInputHandler = ({ inputParam, data, disabled = false, onNodeDataChange }) => {
    ...
    const getCredential = () => {
        const credential = data.inputs.credential || data.inputs[BOOK_GENERATOR_CREDENTIAL_ID]
        if (credential) {
            return { credential }
        }
        return {}
                        ...
                        {inputParam.type === 'credential' && (
                            <CredentialInputHandler
                                ...
                                onSelect={(newValue) => {
                                    ...
                                    data.inputs[BOOK_GENERATOR_CREDENTIAL_ID] = newValue // in case data.credential is not updated
                                }}
                            />
                        )}
