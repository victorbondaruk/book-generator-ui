...
const embedPopupHtmlCode = (chatflowid) => {
    ...
    import Chatbot from "https://cdn.jsdelivr.net/npm/book-generator-embed/dist/web.js"
    Chatbot.init({
...
const embedPopupReactCode = (chatflowid) => {
    return `import { BubbleChat } from 'book-generator-embed-react'
...
const embedFullpageHtmlCode = (chatflowid) => {
    return `<book-generator-fullchatbot></book-generator-fullchatbot>
<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/book-generator-embed/dist/web.js"
    Chatbot.initFull({
        chatflowid: "${chatflowid}",
...
const embedFullpageReactCode = (chatflowid) => {
    return `import { FullPageChat } from "book-generator-embed-react"
...
export const defaultThemeConfig = {
    ...
    disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://destacable.com/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
    ...
    chatWindow: {
        ...
        footer: {
            textColor: '#303235',
            text: 'Powered by',
            company: 'BookGenerator',
            companyLink: 'https://destacable.com'
        }
    }
}
                            ...
                            <span>
                                ...
                                <p>
                                    ...
                                    <a
                                        rel='noreferrer'
                                        target='_blank'
                                        href='https://www.npmjs.com/package/book-generator-embed?activeTab=versions'
                                    >
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/book-generator-embed@<version>/dist/web.js`}</code>
                                </p>
                            </span>
