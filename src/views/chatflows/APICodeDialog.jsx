                        ...
                        {codeLang !== 'Embed' && codeLang !== 'Share Chatbot' && codeLang !== 'Configuration' && (
                            <>
                                            ...
                                            >
                                                ...
                                                <span style={{ color: 'rgb(116,66,16)', marginLeft: 10, fontWeight: 500 }}>
                                                    ...
                                                    <a
                                                        rel='noreferrer'
                                                        target='_blank'
                                                        href='https://docs.destacable.com/using-book-generator/prediction#configuration-override'
                                                    >
                                                        here
                                                    </a>{' '}
                                                    for more details
                                ...
                                {getIsChatflowStreamingApi.data?.isStreaming && (
                                    <p>
                                        Read&nbsp;
                                        <a rel='noreferrer' target='_blank' href='https://docs.destacable.com/using-book-generator/streaming'>
                                            here
                                        </a>
