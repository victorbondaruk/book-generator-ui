    ...
    const handleSaveFlow = (chatflowName) => {
        if (reactFlowInstance) {
            const nodes = reactFlowInstance.getNodes().map((node) => {
                ...
                if (Object.prototype.hasOwnProperty.call(nodeData.inputs, BOOK_GENERATOR_CREDENTIAL_ID)) {
                    nodeData.credential = nodeData.inputs[BOOK_GENERATOR_CREDENTIAL_ID]
                    nodeData.inputs = omit(nodeData.inputs, [BOOK_GENERATOR_CREDENTIAL_ID])
                }
                node.data = {
                    ...nodeData,
                    selected: false,
