...
import { BOOK_GENERATOR_CREDENTIAL_ID } from '@/store/constant'
...
export const ConfigInput = ({ data, inputParam, disabled = false, arrayIndex = null, parentParamForArray = null }) => {
    ...
    const onCustomDataChange = ({ inputParam, newValue }) => {
        ...
        const credential = updatedInputs.credential || updatedInputs[BOOK_GENERATOR_CREDENTIAL_ID]
    ...
    useEffect(() => {
        const loadComponentData = async () => {
            ...
            const credential = componentNodeData.inputs.credential || componentNodeData.inputs[BOOK_GENERATOR_CREDENTIAL_ID]
    ...
    useEffect(() => {
        ...
        const updateComponentData = () => {
            ...
            const credential = updatedComponentData.inputs.credential || updatedComponentData.inputs[BOOK_GENERATOR_CREDENTIAL_ID]
