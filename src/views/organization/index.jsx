                            ...
                            {requiresAuthentication && (
                                <>
                                    <Box>
                                        ...
                                        />
                                        <Typography variant='caption'>
                                            <i>Existing username that was set as BOOK_GENERATOR_USERNAME environment variable</i>
                                        </Typography>
                                    </Box>
                                    <Box>
                                        <div style={{ display: 'flex', flexDirection: 'row' }}>
                                        ...
                                        />
                                        <Typography variant='caption'>
                                            <i>Existing password that was set as BOOK_GENERATOR_PASSWORD environment variable</i>
                                        </Typography>
                                    </Box>
                                    <Divider>
