...
const fetchList = async ({ name, nodeData, previousNodes, currentNode }) => {
    ...
    if (!credentialId && (nodeData.inputs?.credential || nodeData.inputs?.['BOOK_GENERATOR_CREDENTIAL_ID'])) {
        credentialId = nodeData.inputs.credential || nodeData.inputs?.['BOOK_GENERATOR_CREDENTIAL_ID']
    }
